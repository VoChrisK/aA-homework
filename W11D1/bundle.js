...
/*!**********************************!*\
  !*** ./actions/giphy_actions.js ***!
  \**********************************/
/*! exports provided: receiveSearchGiphys, fetchSearchGiphys, RECEIVE_SEARCH_GIPHYS */
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
        className: "giphys-search-form",
        onSubmit: this.handleSubmit.bind(this)
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        type: "text",
        className: "giphys-text",
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: "GET",
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=", "1GEoLgdOqklHpayczQuNE8toXqU1FBmJ", "&limit=2")
  });
};
